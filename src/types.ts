...
export type AppTheme = 'light' | 'dark' | 'google' | 'google-dark' | 'win95' | 'winxp' | 'win7' | 'win31' | 'wikidiota' | 'genshin' | 'android15' | 'stardew' | 'repo' | 'minecraft' | 'roblox' | 'nokia3310' | 'win1' | 'halflife';
