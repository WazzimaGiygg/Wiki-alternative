...
export const IrregularidadesDossierModal: React.FC<IrregularidadesDossierModalProps> = ({
  ...
  const pdfUrl = '/Irregularidades%20da%20Wikip%C3%A9dia%20e%20Wikimedia%20Foundation.pdf';
  const pdfDownloadName = 'Irregularidades da Wikipédia e Wikimedia Foundation.pdf';
      ...
      <div className="bg-white dark:bg-[#0f172a] border border-slate-300 dark:border-slate-800 rounded-2xl shadow-2xl max-w-5xl w-full max-h-[92vh] flex flex-col overflow-hidden font-sans">
        ...
        <div className="p-4 sm:p-5 border-b border-slate-200 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-900/80 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-start gap-3">
            <div className="w-11 h-11 rounded-xl bg-gradient-to-tr from-rose-600 via-red-600 to-amber-600 text-white flex items-center justify-center shadow-md shrink-0 ring-4 ring-rose-50 dark:ring-rose-950/40">
              <FileText size={22} />
            </div>
            <div>
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-7 space-y-6 text-xs text-slate-700 dark:text-slate-300 leading-relaxed font-sans">
          ...
          {activeTab === 'table' && (
            <div className="max-w-4xl mx-auto space-y-4">
              <div className="p-3.5 rounded-lg bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800 text-xs text-blue-900 dark:text-blue-200">
                <strong>Quadro Sinóptico Comparativo:</strong> Demonstração direta do abismo normativo entre a conduta infratora da Wikimedia Foundation e a conformidade plena da WikiWorldWeb.
              </div>
                ...
                <table className="w-full text-left text-xs border-collapse">
                  ...
                  <tbody className="divide-y divide-slate-200 dark:divide-slate-800 text-[11px]">
                    ...
                    <tr>
                      ...
                      <td className="p-3 text-rose-600 dark:text-rose-400 bg-rose-50/30 dark:bg-rose-950/10">
                        Publicação frequente de nomes e fotos de menores sem tutela ao seu melhor interesse.
                      </td>
                      <td className="p-3 text-emerald-700 dark:text-emerald-300 font-medium bg-emerald-50/30 dark:bg-emerald-950/10">
                        Vedação total de exposição de menores sem notoriedade autônoma comprovada.
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="h-[600px] w-full rounded-xl overflow-hidden border border-slate-300 dark:border-slate-800 bg-slate-100 dark:bg-slate-900 flex flex-col">
              <div className="p-2.5 bg-slate-200 dark:bg-slate-800 flex items-center justify-between text-xs">
                ...
                <a
                  href={pdfUrl}
                  download={pdfDownloadName}
                  className="px-2.5 py-1 rounded bg-rose-600 hover:bg-rose-700 text-white font-bold flex items-center gap-1 text-[11px]"
                >
                  <Download size={12} />
              ...
              <iframe
                ...
                title="Visualizador PDF Irregularidades da Wikipédia"
              />
            </div>
          )}
        </div>
        ...
        <div className="p-4 bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
          <div className="flex items-center gap-2 text-slate-500 dark:text-slate-400 text-[11px]">
            ...
            <span>Documento emitido para instrução de cidadãos, acadêmicos e autoridades competentes (ANPD / MPF).</span>
          </div>
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
            <a
              href={pdfUrl}
              download={pdfDownloadName}
              className="px-4 py-1.5 rounded-lg bg-rose-600 hover:bg-rose-700 text-white font-bold transition flex items-center gap-1.5 shadow-xs"
            >
              <Download size={14} />
              <span>Baixar PDF Oficial (23 KB)</span>
            </a>
