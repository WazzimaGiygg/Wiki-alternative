...
= Visão Geral =
O '''Metropolitano de São Paulo''', comumente conhecido como '''Metrô de São Paulo''', é o principal sistema de transporte de alta capacidade do estado de São Paulo e o mais extenso do Brasil.

== Primeiras Propostas (1927–1966) ==
As primeiras discussões sobre transportes subterrâneos em São Paulo remontam a 1927, quando a concessionária canadense *Light* propôs um sistema de túneis no centro da cidade. Contudo, foi apenas no final da década de 1960 que os estudos coordenados pela prefeitura e o consórcio alemão-brasileiro *HMD (Hochtief-Montreal-Deconsult)* definiram as bases da malha moderna.

== Inauguração da Linha 1 - Azul ==
Em 14 de setembro de 1974, entrou em operação o primeiro trecho comercial entre as estações **Jabaquara** e **Vila Mariana**, operado com trens com tração elétrica controlada por chopper de tiristor, pioneiro na América Latina.

=== Características Técnicas da Malha ===
* '''Bitola:''' 1.600 mm (Bitola Larga) na maioria das linhas; 1.435 mm (Bitola Internacional) nas Linhas 4-Amarela e 5-Lilás.
...
== Ver Também ==
* [[WikiZero & Enciclopédias Livres|Artigo sobre o WikiZero]]
* [[Guia de Edição MediaWiki|Aprenda a formatar artigos no Metrô]]
    ...
    historico: [
      {
        ...
        autor: 'WazzimaGiygg',
        resumo: 'Atualização da tabela de linhas e infobox com dados de passageiros',
        tamanho: 2840,
      },
      {
        id: 'h-2',
...
O Metrô de São Paulo opera com diversas frotas de composições de 6 a 7 carros, fabricadas por consórcios nacionais e internacionais como Mafersa, Cobrasma, Alstom, CAF, Hyundai Rotem e Bombardier.
...
> "A modernização das frotas estendeu a vida útil operacional dos trens em mais 20 anos, incorporando ar-condicionado e sistemas modernos de tração VVVF."

== Veja Também ==
* [[História do Metrô de São Paulo|Voltar para a história geral]]`,
  },
  {
    id: 'art-wiki-01',
...
= O que é a WikiZero? =
A '''WikiZero''' é uma plataforma enciclopédica colaborativa, desenvolvida para fornecer acesso desimpedido, rápido e seguro ao conhecimento humano. 
...
== Sintaxe Suportada ==
A WikiZero adota o padrão '''MediaWiki / Wikitext''', permitindo compatibilidade universal com a Wikipedia clássica:
* Cabeçalhos: \`== Título ==\` e \`=== Subtítulo ===\`
* Ênfase: \`'''Negrito'''\` e \`''Itálico''\`
* Hiperligações: \`[[Título do Artigo|Texto Alternativo]]\`
* Tabelas MediaWiki e blocos de código formatados.
...
* [[Direitos Digitais & LGPD no Brasil|Consulte nossa conformidade com a LGPD]]`,
  },
  {
    id: 'art-wiki-02',
    pageUid: 'wikizero_info',
...
== 3. Listas ==
* Use \`* Item\` para listas com marcadores
* Use \`# Item\` para listas numeradas
...
== 5. Caixa de Informações (Infobox) ==
\`\`\`
{{Infobox
...
Experimente no nosso [[Editor Wikitexto|Editor em Tempo Real]]!`,
  },
  {
    id: 'art-lgpd-01',
...
A **Lei Geral de Proteção de Dados (Lei nº 13.709/2018)** regulamenta o tratamento de dados pessoais no Brasil.
...
export const INITIAL_NOTIFICATIONS: NotificationItem[] = [
  {
    id: 'notif-1',
    title: '🎉 Bem-vindo à WikiZero v3.0 Otimizada',
    message: 'Sistema reestruturado com suporte completo a Wikitext, exportação e alta performance.',
    date: 'Hoje, 16:20',
    read: false,
    type: 'success',
  },
  {
    id: 'notif-2',
    title: '⚡ Novo Editor em Tempo Real',
    message: 'O editor agora conta com divisão em tela cheia, estatísticas ao vivo e salvamento de rascunhos.',
    date: 'Hoje, 15:40',
    read: false,
    type: 'info',
  },
